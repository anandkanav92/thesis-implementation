...
if __name__ == '__main__':
  ...
  params = {"epochs": {"value": 200, "comment": ""}, "batchSize": {"value": 100.0, "comment": ""}, "lossFunction": {"value": "cross_entropy", "comment": ""}, "optimizer": {"value": "adam_optimizer", "comment": ""}, "learningRate": {"value": .001, "comment": ""}, "epsilon": {"value": 1e-08, "comment": ""}, "weightDecay": {"value": 0, "comment": ""}, "rho": {"value": 0.9, "comment": ""}, "learningRateDecay": {"value": 0, "comment": ""}, "initialAccumulator": {"value": 0.0001, "comment": ""}, "alpha": {"value": 0.0001, "comment": ""}, "lambda":{"value": 0.0001, "comment": ""}, "momentum": {"value": 0.0001, "comment": ""}, "user_id": "F88BC8"}
  main(params,logger)
